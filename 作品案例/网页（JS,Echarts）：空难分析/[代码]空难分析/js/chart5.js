...
// 重庆
var CQData = [
    [{name: '北京'}, {name: "芬兰",value: 30}],
    [{name: '北京'}, {name: "德国",value: 90}],
    [{name: '北京'}, {name: "英国",value: 30}],
    [{name: '北京'}, {name: "韩国",value: 30}]
];
...
*/
[['北京', CQData],['广州', GZData],['上海', NNData]].forEach(function(item, i) {
    series.push({
        // 白色航线特效图
        type: 'lines',    
